...
?>
		...
		<img src="../img/pierre.png" alt="" width="25px" style="margin-top: 10px;"/>
                <h1> Mise en vente sur le site marchand </h1>		
...
<?php 
	...
	if(isset($_POST['prix']) && isset($_POST['nom']) && isset($_POST['idbijou'])){
	
		Bijou::MettreEnVente($_POST['idbijou'], $_POST['prix'], $_POST['nom']);
	...
	echo"
	<br>
	<form action='miseenvente.php' method='post'>
	<label><b>Prix de l'objet : </b></label><input type='number' name='prix' required /></br>
	<label><b>Nom de l'objet : </b></label><input type='text' name='nom' required /></br>
