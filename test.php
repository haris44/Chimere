...
?>
		...
		<form action="addbijou.php" method="post" enctype="multipart/form-data">
			...
			<label>Devis : </label><input type="text" name="devis" required ><br>
			<label>Estimation : </label><input type="text" name="estimation" required ><br>
			<label>Nombre d'heure prévu : </label><input type="text" name="hprevu" required ><br>
